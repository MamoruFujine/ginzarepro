...
<div class="page-wrap">
    ...
    <article class="contents__article article_cases">
      <div class="contents__text">
        <div class="toc_top_bnr">
          <a href="https://ginzarepro.jp/contact/appointment-first/" target="_blank" rel="noopener">
            <picture class="img"><source media="(min-width: 769px)" srcset="https://ginzarepro.jp/wp-content/themes/ginzarepro_0.1/img/bnr_reserve@2x.png"><source media="(max-width: 768px)" srcset="https://ginzarepro.jp/wp-content/themes/ginzarepro_0.1/img/bnr_reserve_sp.png"><img loading="lazy" decoding="async" src="https://ginzarepro.jp/wp-content/themes/ginzarepro_0.1/img/bnr_reserve@2x.png" alt="ナガオメソッド 累計施術件数  約10,000件　年間800件以上 精液所見改善率 87% 再発率 0.5%以下 ご予約はこちら" width="1059" height="195">
            </picture>
          </a>
        </div>
      </div>
      ...
      <div class="btn-link"><a href="https://ginzarepro.jp/sinryo/varicocele/#i-17">精索静脈瘤手術・ナガオメソッドについて詳しくはこちら</a></div>
        ...
        <div class="js-tab">
          <div class="record_tab">
            <ul class="clearfix">
              <li class="nagao"><a href="#record_content01" class="hover js-tab-trigger active">日帰り<br class="sp">顕微鏡下精索静脈瘤手術<span>・ナガオメソッド</span></a></li>
              <li class="other"><a href="#record_content02" class="hover js-tab-trigger">一括結紮法<span>（一般的に行われている<br class="sp">手術法）</span></a></li>
            </ul>
          </div><!-- record_tab -->
          <div class="record_content-wrap">
                              ...
                              <div class="flex-box">
                                ...
                                if(!empty($record_nagao_1 || $record_nagao_2 || $record_nagao_3 || $record_nagao_4 || $record_nagao_5 || $record_nagao_6 || $record_nagao_7 || $record_nagao_8 || $record_nagao_9 || $record_nagao_10 )){ 
                                  ...
                                  if(!empty($record_nagao_5)){ $rowspan_nagao++; }
                                    ...
                                    echo '<tr>'.PHP_EOL;
                                    echo '<th class="th01 clr_01" rowspan="'.$rowspan_nagao.'">温存</th>'.PHP_EOL;
                                    echo '</tr>'.PHP_EOL;
                                  }
                                  ...
                                  if(!empty($record_nagao_10)){ $rowspan_nagao2++; }
                                    ...
                                    echo '<tr>'.PHP_EOL;
                                    echo '<th class="th01 clr_02" rowspan="'.$rowspan_nagao2.'">結紮</th>'.PHP_EOL;
                                    echo '</tr>'.PHP_EOL;
                                  }
              ...
              <div class="flex-box">
                        ...
                        <?php endif; ?>
                                ...
                                if(!empty($record_other_1 || $record_other_2 || $record_other_3 || $record_other_4 || $record_other_5 || $record_other_6 || $record_other_7 || $record_other_8 || $record_other_9 || $record_other_10 )){ 
                                  ...
                                  echo '<div class="tbl-inner">'.PHP_EOL;
                                  ...
                                  if(!empty($record_other_5)){ $rowspan_other++; }
                                    ...
                                    echo '<tr>'.PHP_EOL;
                                    echo '<th class="th01 clr_01" rowspan="'.$rowspan_other.'">温存</th>'.PHP_EOL;
                                    echo '</tr>'.PHP_EOL;
                                  }
                                  ...
                                  if(!empty($record_other_6 || $record_other_7 || $record_other_8 || $record_other_9 || $record_other_10 )){
                                    ...
                                    echo '<tr>'.PHP_EOL;
                                    echo '<th class="th01 clr_02" rowspan="'.$rowspan_other2.'">結紮';
                                    echo '</th>'.PHP_EOL;
                                    echo '</tr>'.PHP_EOL;
                                  }
                                  ...
                                  if(!empty($rowspan_otherx)){
                                    ...
                                    echo '<div class="att-txt pc-'.$record_other_display.'">損傷</div>';
                                  }
                                    echo '</div>'.PHP_EOL;
                                    echo '</div>'.PHP_EOL;
                                }
            ...
            <div class="btn_list-records">
              <div class="btn_r"><a href="https://ginzarepro.jp/contact/appointment-first/">予約はこちら</a></div>
              <div class="btn_r"><a href="https://ginzarepro.jp/sinryo/nagao_method/">ナガオメソッドの詳細はこちら</a></div>
            </div>
