...
<footer class="footer<?php if (is_single(array('varicocele','varicocele_test'))){ echo ' f-sinryo-sblue';} ?>">
        ...
        <div class="footer__about__practiceTime--wrap">
          ...
          ※学会参加などで休診の場合がございます。
            ...
            <ul class="english-site">
                ...
                <li><a href="https://ginzarepro.jp/sinryo/varicocele-en/" target="_blank" class="footer__navi__item__child">Varicocelectomy</a></li>
arepro.jp/sinryo/nagao_method-en/" target="_blank" class="footer__navi__item__child">Nagao method</a></li>
                <li><a href="https://ginzarepro.jp/sinryo/pipe-cut-reconstruction-en/" target="_blank" class="footer__navi__item__child">Vasectomy Reversa</a></li>
            </ul>
        </div>
        ...
        <ul class="footer__navi--wrap">
            ...
            <li>
                ...
                <ul class="footer__navi__item__lower--wrap">
                    <li><a class="footer__navi__item__lower" href="<?php echo esc_url(home_url('/sinryo/varicocele/')); ?>">精索静脈瘤治療</a></li>
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/nagao_method/')); ?>" class="footer__navi__item__child">日帰り顕微鏡下精索静脈瘤手術・ナガオメソッド</a>
                        </li>
                        <li>
                        <a href="<?php echo esc_url(home_url('/sinryo/varicocele/')); ?>" class="footer__navi__item__child">精索静脈瘤検診</a>
                        </li>
                    </ul>
                    ...
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/lva/')); ?>" class="footer__navi__item__child">LVA手術（リンパ管細静脈吻合術）</a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/lymph_drainage/')); ?>" class="footer__navi__item__child">銀座リプロ式リンパドレナージ</a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(home_url('/column/rubber-stockings/')); ?>" class="footer__navi__item__child">オーダーメイド弾性ストッキング</a>
                        </li>
                    </ul>

                    <li><a class="footer__navi__item__lower" href="<?php echo esc_url(home_url('/sinryo/%e9%9b%a3%e6%b2%bb%e6%80%a7ed%e5%a4%96%e6%9d%a5/')); ?>">難治性ED治療</a></li>
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/penile-injections/')); ?>" class="footer__navi__item__child">海綿体・陰茎注射</a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/prosthetic/')); ?>" class="footer__navi__item__child">日帰り陰茎プロステーシス手術</a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(home_url('/lp/prosthesis/')); ?>" class="footer__navi__item__child">陰茎プロステーシス手術特設ページ</a>
                        </li>
                    </ul>
                    <li><a class="footer__navi__item__lower">陰茎湾曲症治療</a></li>
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/inkei/')); ?>" class="footer__navi__item__child">日帰り顕微鏡下陰茎彎曲症手術</a>
                        </li>
                    </ul>
                    <li><a class="footer__navi__item__lower">パイプカットおよび再建手術</a></li>
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/about-pipecut/')); ?>" class="footer__navi__item__child">日帰り顕微鏡下パイプカット手術（避妊手術）</a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/pipe-cut-reconstruction/')); ?>" class="footer__navi__item__child">日帰り顕微鏡下パイプカット再建手術（男性不妊治療・妊活）</a>
                        </li>
                    </ul>
                    <li><a class="footer__navi__item__lower" href="<?php echo esc_url(home_url('/')); ?>">免疫療法</a></li>
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/nk/')); ?>" class="footer__navi__item__child">NK細胞療法</a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(home_url('/sinryo/cat/')); ?>" class="footer__navi__item__child">T細胞療法</a>
                        </li>
                    </ul>
                    <li><a class="footer__navi__item__lower" href="<?php echo esc_url(home_url('/')); ?>">その他</a></li>
                    <ul class="footer__navi__item__child--wrap">
                        <li>
                            <a href="https://ginzarepro.jp/sinryo/gikougan/" class="footer__navi__item__child">精巣インプラント（偽睾丸挿入術）</a>
                        </li>
                        <li>
                            <a href="https://ginzarepro.jp/sinryo/scrotal-ptosis-surgery/" class="footer__navi__item__child">陰嚢下垂手術</a>
                        </li>
                    </ul>
...
<ul class="footer__navi__item__child--wrap">
            ...
            <li><span class="footer__navi__item">English Contents</span></li>
            <li><a href="https://ginzarepro.jp/sinryo/varicocele-en/" target="_blank" class="footer__navi__item__child">Varicocelectomy</a></li>
            <li><a href="https://ginzarepro.jp/sinryo/nagao_method-en/" target="_blank" class="footer__navi__item__child">Nagao method</a></li>
            <li><a href="https://ginzarepro.jp/sinryo/pipe-cut-reconstruction-en/" target="_blank" class="footer__navi__item__child">Vasectomy Reversa</a></li>
            <?php endif; ?>
    ...
    <div class="footer__spNavi">
        ...
        <div class="footer__spNavi">
            ...
            <div class="footer__spNavi">
                <a class="footer__spNavi__item" style="width: calc(24.5% - (0px / 4));" href="/contact/appointment-first/" target="_blank">
                    <div class="footer__spNavi__item--inner">
                        <img class="footer__spNavi__item__img" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/footer__spNavi__item__img--reservation.png" alt="" />
                        <p class="footer__spNavi__item__text">初診予約</p>
                    </div>
                </a>
                <a class="footer__spNavi__item" style="width: calc(25% - (0px / 4));" href="/contact/appointment-revisit/">
                    <div class="footer__spNavi__item--inner">
                        <img class="footer__spNavi__item__img" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/footer__spNavi__item__img--reservation.png" alt="" />
                        <p class="footer__spNavi__item__text">再診予約</p>
                    </div>
...
<?php if(is_tax('column_category','varicocele') || (is_singular('post') && is_object_in_term($post->ID,'column_category','varicocele')) ){ ?>
  ...
  <p><a href="<?php echo esc_url(home_url('/contact/appointment-first/')); ?>"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/bnr_vc.png" alt="LVA" width="540" height="540"></a></p>
