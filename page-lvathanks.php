...
<?php get_header('woman'); ?>
 <div class="page-wrap">
    <section class="lowerHeader">
        <ul class="lowerHeader__breadcrumbs"><li><a class="lowerHeader__breadcrumbs__home" href="/woman/"><img src="/wp-content/themes/ginzarepro_0.1/img/breadcrumbs__home.png" alt=""></a></li><li class="lowerHeader__breadcrumbs__current">送信完了</li></ul>
...
<div class="btn_dl"><a href="<?php echo esc_url(home_url()); ?>/pdf/lva_information.pdf" class="contents__item__permalink" download="LVAのご案内 [PDF]" target="_blank">LVAのご案内 [PDF]</a></div>

          <br>
          <div class="contact__btn">
            <a class="contact__btn--back" href="/woman/">TOPに戻る</a>
          </div>
      </article>
    </section>
