...
<?php get_header('woman'); ?>
 ...
 <div class="page-wrap<?php if(is_page(array('appointment-first','appointment-first_lp','appointment-first-confirm','appointment-first-confirm_lp'))){ echo ' contact-wrap';} ?>">
    <section class="lowerHeader">
        <ul class="lowerHeader__breadcrumbs"><li><a class="lowerHeader__breadcrumbs__home" href="/woman/"<?php if(is_page(array('appointment-first','appointment-first_lp' ))){ echo ' target="_blank"';} ?>><img src="/wp-content/themes/ginzarepro_0.1/img/breadcrumbs__home.png" alt=""></a></li><li><a class="lowerHeader__breadcrumbs__link" href="/sinryo/lva/"<?php if(is_page(array('appointment-first','appointment-first_lp' ))){ echo ' target="_blank"';} ?>>リンパ浮腫の治療・手術（日帰りリンパ管静脈吻合術・LVA）</a></li><li class="lowerHeader__breadcrumbs__current"><?php if(is_page( array('appointment-first','appointment-first_lp','appointment-first-confirm','appointment-first-confirm_lp' ) ) ): ?>初診<?php else :?>再診<?php endif; ?>のご予約</li></ul>
...
再診をご希望の方は <a href="<?php echo esc_url(home_url()); ?>/lva/appointment-revisit/" target="_blank">&gt;再診予約</a> から<br>それ以外の方は <a href="<?php echo esc_url(home_url()); ?>/contact/" target="_blank">&gt;お問い合わせ</a> からご連絡ください。</p>
          <!--<p class="lowerHeader__description">
初診の方はこちらのフォームよりお申し込みください。<br>
再診をご希望の方は<a href="/lva/appointment-revisit/" target="_blank">「再診のご予約」</a>のフォームから、<br>それ以外のご予約の方は<a href="/woman/contact/" target="_blank">「お問い合わせ」</a>よりお問い合わせください。</p>-->
<?php elseif(is_page( 'appointment-revisit' ) ): ?>
          <p class="lowerHeader__description">
 すでに銀座リプロ外科にて診療いただいたことのある方のお申し込みフォームです。<br>
初めて診察を受ける方は<a href="/lva/appointment-first/" target="_blank">「初診のご予約」</a>のフォームから、<br>それ以外のご予約の方は<a href="/woman/contact/" target="_blank">「お問い合わせ」</a>よりお問い合わせください。</p>

<?php elseif(is_page( array('appointment-first-confirm','appointment-first-confirm_lp','appointment-revisit-confirm' ) )): ?>
...
<?php if(is_page( array('appointment-first','appointment-first_lp','appointment-revisit' ) )): ?>
          ...
          <div class="contact__attention">
            ...
            <p><?php /*・ご予約依頼をいただきましたら、メールにてご返信させていただきます。<br>
・本フォーム入力をもって予約完了とはなりませんのでご注意ください。<br>
・*/?>当院からのメールが受信できない方がいらっしゃいます。迷惑メール対策を実施している場合は、&#64;&#103;&#105;&#110;&#122;&#97;&#114;&#101;&#112;&#114;&#111;&#46;&#106;&#112; からのメールが受信できるよう設定してください。<br>
医師のご希望がある場合は「備考」にご記入ください。<br>
<?php /*・未成年者および学生の方は、保護者同伴で受診していただけますようお願いいたします。もし、遠方などの理由で保護者が同伴できない場合は、予め同意を取られてから受診していただけますようお願いいたします。</a> */?>
...
<?php if(is_page( 'appointment-first' )): ?>
        <?php echo do_shortcode('[mwform_formkey key="1597"]'); ?>
<?php elseif(is_page( 'appointment-first_lp' )): ?>
        <?php echo do_shortcode('[mwform_formkey key="9963"]'); ?>
<?php elseif(is_page( 'appointment-revisit' )): ?>
        <?php echo do_shortcode('[mwform_formkey key="1598"]'); ?>
...
<?php if(!is_page(array('appointment-first-confirm','appointment-first-confirm_lp'))){ ?>
    ...
    <?php if(!is_page( array('appointment-first','appointment-first_lp','appointment-first-confirm','appointment-first-confirm_lp') )){ ?>
