...
<head>
    ...
    <title>精索静脈瘤とは？症状や検査方法、治療・手術方法を解説｜銀座リプロ外科</title>
    <?php else : ?>
    <?php if (is_home() || is_front_page()) :  ?>
    <title>銀座リプロ外科 東京の男性不妊治療｜医療法人社団マイクロ会</title>
    <?php else : ?>
    <title><?php if (!is_home() || !is_front_page() || !is_tag()) : ?><?php echo $pageTitle ?><?php endif; ?>男性不妊治療・手術は銀座リプロ外科</title>
    <?php endif; ?>
    <?php endif; ?>
    ...
    <meta name="description" content="ED薬でも勃起しなかった場合、海綿体・陰茎注射（ICI治療）が効果的です。当院ではプロスタグランジンE1による陰茎注射を自己負担治療で行っております。当院では日帰り顕微鏡下手術にて様々な症状の外科手術を行っております。銀座一丁目駅徒歩2分。">
    <?php elseif (is_single('69')) : ?>
    <meta name="description" content="不妊の原因は女性だけでなく、男性に問題がある場合もあります。男性不妊症は、造精機能障害や生活習慣などさまざまな原因が考えられます。そのため、受診により原因を探り適切な治療方法を選びましょう。">

    <?php elseif (is_single('1830')) : ?>
    <meta name="description" content="精索静脈瘤とは、精巣やその上の精索部に静脈瘤ができる症状を指します。精索静脈瘤は成人男性のみいならず、子供でも発生することがあります。遺伝や特定の原因はありませんが、精索静脈瘤は進行性の病気のため、早期診断と早期治療が重要です。">
    <?php elseif (is_single('2791')) : ?>
    <meta name="description" content="頑張らず、他力本願で、お金がかからない、そして気持ちいい♪ 無理なく続けられる銀座リプロ式リンパドレナージのご紹介です。保存療法のための通院が続かない・毎日行うことができない・効果が上がらない方にお薦めいたします。">
    <?php elseif (is_single('2695')) : ?>
    <meta name="description" content="At Ginza Reproductive Surgery, we focus on treatable male infertility. We specialize in microsurgery, daytime Varicocelectomy, daytime penile prosthesis surgery and penile sponge injections. We provide a variety of male sexual function treatments to help men feel confident in their work.">
    <?php elseif (is_single('2562')) : ?>
    <meta name="description" content="Ginza Reproductive Surgery offers vasectomy reconstructive surgery by expert microsurgery surgeons. Our vasectomy reconstruction has a high treatment record with a 91% sperm appearance rate and 47% normalization rate.">
    <?php elseif (is_single('2872')) : ?>
    <meta name="description" content="当クリニックでは、アルファ･ベータT細胞(αβT細胞療法)を行っています。T細胞療法とは、がん細胞を攻撃する免疫細胞であるアルファ･ベータT細胞、NK細胞などのリンパ球全体を増殖･活性化して投与する治療法です。免疫力全体が底上げされ、化学療法や放射線治療との併用も可能です。">
...
妊娠の可能性をあげるためには、日々の規則正しい生活習慣などや身体の環境を整える必要があります。">
    ...
    <meta name="description" content="顕微授精とは、顕微鏡下で卵子に直接精子を注入して受精させ、奥様の子宮に受精卵を戻すという方法です。男性側の精子の量が少ない場合でも受精させることができるといったメリットの一方で、卵子を傷つけしまうリスクがあるなどデメリットもあります。">
...
また、男性不妊と関連する病気も多岐にわたるため、不安な方は専門医に相談することをおすすめします。">
    ...
    <meta name="description" content="初診当日に顕微鏡下精索静脈瘤手術（ナガオメソッド・自費診療）を希望される場合は、ご予約時に必ず「同日に手術」という旨をお申し出ください。また、事前準備・費用・術前検査などについてもご確認ください。">
    <?php else : ?>
    <meta name="description" content="<?php echo $pageDesc ?>">
    <?php endif; ?>

    <meta property="og:title" content="<?php if (!is_home() || !is_front_page()) : ?><?php echo $pageTitle ?>男性不妊治療・手術は銀座リプロ外科<?php else : ?>銀座リプロ外科 東京の男性不妊治療｜医療法人社団マイクロ会<?php endif; ?>" />
    <meta property="og:site_name" content="銀座リプロ外科 東京の男性不妊治療｜医療法人社団マイクロ会" />
    ...
    <meta name="twitter:title" content="<?php if (!is_home() || !is_front_page()) : ?><?php echo $pageTitle ?>男性不妊治療・手術は銀座リプロ外科<?php else : ?>銀座リプロ外科 東京の男性不妊治療｜医療法人社団マイクロ会<?php endif; ?>" />
    ...
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/css/eat.css" />
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/css/sns.css" />
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/css/styletop.css" />
                ...
                <ul class="sideNavi__menu">
                    ...
                    <li class="sideNavi__menu__trigger_2 accordion">
                        ...
                        <ul class="sideNavi__menu__lower sinryo ">
                            <li class="link--sp"><a class="sideNavi__menu__lower__item--sp" href="/sinryo/">診療・手術一覧</a></li>
                            <li>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    ...
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/nagao_method/" class="sideNavi__navi__item__child">日帰り顕微鏡下精索静脈瘤手術・ナガオメソッド</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    <!--<li class="link--sp"></li>-->
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/inkei/" class="sideNavi__navi__item__child">日帰り顕微鏡下陰茎彎曲症手術</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    ...
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/lva/" class="sideNavi__navi__item__child">LVA手術（リンパ管細静脈吻合術）</a>
                                    </li>
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/lymph_drainage/" class="sideNavi__navi__item__child">銀座リプロ式リンパドレナージ</a>
                                    </li>
                                    <li>
                                        <a href="https://ginzarepro.jp/column/rubber-stockings/" class="sideNavi__navi__item__child">オーダーメイド弾性ストッキング</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a class="sideNavi__menu__item--pc sideNavi__menu__lower__item" href="#">パイプカットおよび再建手術</a>
                                <label class="sideNavi__menu__item--sp link-txt" for="menu_sinryo_5">パイプカットおよび再建手術</label>
                                <input type="checkbox" id="menu_sinryo_5" class="toggle">
                                <label class="arw" for="menu_sinryo_5">▼</label>
                                <ul class="sideNavi__navi__item__child--wrap">
                                    <!--<li class="link--sp"></li>-->
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/about-pipecut/" class="sideNavi__navi__item__child">日帰り顕微鏡下パイプカット手術（避妊手術）</a>
                                    </li>
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/pipe-cut-reconstruction/" class="sideNavi__navi__item__child">日帰り顕微鏡下パイプカット再建手術（男性不妊治療・妊活）</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a class="sideNavi__menu__item--pc sideNavi__menu__lower__item" href="/sinryo/%e9%9b%a3%e6%b2%bb%e6%80%a7ed%e5%a4%96%e6%9d%a5/">難治性ED治療</a>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    ...
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/prosthetic/" class="sideNavi__navi__item__child">日帰り陰茎プロステーシス手術</a>
                                    </li>
                                    <li>
                                        <a href="https://ginzarepro.jp/lp/prosthesis/" class="sideNavi__navi__item__child">陰茎プロステーシス手術特設ページ</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    <!--<li class="link--sp"></li>-->
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/nk/" class="sideNavi__navi__item__child">NK細胞療法</a>
                                    </li>
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/cat/" class="sideNavi__navi__item__child">T細胞療法</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    <!--<li class="link--sp"></li>-->
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/varicocele-jhs-students/" class="sideNavi__navi__item__child">小児精索静脈瘤</a>
                                    </li>
                                    <!--<li>
                                        <a href="https://ginzarepro.jp/sinryo/penile-injections/" class="sideNavi__navi__item__child">陰茎海綿体注射</a>
                                    </li>-->
                            ...
                            <li>
                                ...
                                <ul class="sideNavi__navi__item__child--wrap">
                                    <!--<li class="link--sp"></li>-->
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/gikougan/" class="sideNavi__navi__item__child">精巣インプラント（偽睾丸挿入術）</a>
                                    </li>
                                    <li>
                                        <a href="https://ginzarepro.jp/sinryo/scrotal-ptosis-surgery/" class="sideNavi__navi__item__child">陰嚢下垂手術</a>
                                    </li>
                                    <?php /*<li>
                                        <a href="<?php echo home_url();?>/sinryo/starformer/" class="sideNavi__navi__item__child">高強度のテスラ磁気刺激治療（スターフォーマー
                                    <!-- &trade; -->）</a>
                            </li>*/ ?>
                        </ul>
                    </li>
...
<?php endif;
        ...
        <a class="sideNavi__menu__item" href="/sinryo/#forWomen">女性向け手術</a>
                ...
                <ul style="margin:10px; text-align: center;">
                    <li style="padding-bottom:10px;"><a href="/sinryo/varicocele/"><img src="/wp-content/themes/ginzarepro_0.1/img/bn1.webp" alt="精索静脈瘤とは？" style="max-width: 100%;"></a></li>
                    <li style="padding-bottom:10px;"><a href="/sinryo/nagao_method/"><img src="/wp-content/themes/ginzarepro_0.1/img/bn2.webp" alt="ナガオメソッド" style="max-width: 100%;"></a></li>
                    <li><a href="https://www.youtube.com/channel/UC8A7zCAuY1NXZDgNPXE9awg" target="_blank"><img src="/wp-content/themes/ginzarepro_0.1/img/bn03.webp" alt="youtubeバナー" style="max-width: 100%;"></a></li>
                </ul>
                </ul>
      ...
      <a class="sideNavi__contact--btn" href="/contact/appointment-revisit/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/sideNavi__contact__operation.png" alt="" />再診のご予約</a>-->
                    ...
                    <a class="sideNavi__contact--btn" href="/lva/appointment-first/" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/sideNavi__contact__reservation.png" alt="" />初診のご予約</a>
                    <a class="sideNavi__contact--btn" href="/lva/appointment-revisit/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/sideNavi__contact__operation.png" alt="" />再診のご予約</a>

                    <?php else : ?>

                    <a class="sideNavi__contact--btn" href="/contact/appointment-first/" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/sideNavi__contact__reservation.png" alt="" />初診のご予約</a>
                    <a class="sideNavi__contact--btn" href="/contact/appointment-revisit/"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/sideNavi__contact__operation.png" alt="" />再診のご予約</a>
